      ...
      >
        <SwiperSlide>
          <div className='w-full h-[calc(100vh_-_80px)] flex justify-center items-center bg-slide1 bg-cover bg-center'>
            <div className='w-full h-full bg-black bg-opacity-80 flex items-center justify-center flex-col gap-4'>
              <p className='text-light-yellow'><FormattedMessage id="banner1-text"/></p>
              <h2 className='text-dark-yellow text-5xl font-bold uppercase'><FormattedMessage id="banner1-title"/></h2>
            </div>
          </div>
        </SwiperSlide>
          ...
          <div className='w-full h-[calc(100vh_-_80px)] flex justify-center items-center bg-slide2 bg-cover bg-center'>
            <div className='w-full h-full bg-black bg-opacity-80 flex items-center justify-center flex-col'>
              <div className="containeer flex items-start justify-center flex-col gap-4">
                <h2 className='text-dark-yellow text-5xl font-bold uppercase'><FormattedMessage id="banner2-title"/></h2>
                <p className='text-light-yellow'><FormattedMessage id="banner2-text"/></p>
                <p className='text-light-yellow'><FormattedMessage id="banner2-text2"/></p>
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className='w-full h-[calc(100vh_-_80px)] flex justify-center items-center bg-slide3 bg-cover bg-center'>
            <div className='w-full h-full bg-black bg-opacity-80 flex items-center justify-center flex-col gap-4'>
              <div className="containeer flex items-end justify-center flex-col gap-4">
                <h2 className='text-dark-yellow text-5xl font-bold uppercase '><FormattedMessage id="banner3-title"/></h2>
                <p className='text-light-yellow text-right max-w-[600px]'><FormattedMessage id="banner3-text"/></p>
              </div>
            </div>
          </div>
        </SwiperSlide>
          ...
          <div className='w-full h-[calc(100vh_-_80px)] flex justify-center items-center bg-slide4 bg-cover bg-center'>
            <div className='w-full h-full bg-black bg-opacity-80 flex items-center justify-center flex-col gap-4'>
              <div className="containeer flex items-center justify-center flex-col gap-4">
                ...
                <p className='text-light-yellow'><FormattedMessage id="banner4-text"/></p>
              </div>
            </div>
          </div>
        </SwiperSlide>
