  ...
  return (
    <div className='z-20' id="banner">
      ...
      >
        ...
        <SwiperSlide>
          <div className='w-full h-[calc(100vh_-_80px)] flex justify-center items-center bg-machinenew bg-cover bg-center'>
            <div className='w-full h-full bg-black bg-opacity-80 flex items-center justify-center flex-col gap-4'>
              <h2 className='text-dark-yellow xs:text-xl md:text-4xl font-bold uppercase'>
                <FormattedMessage id="banner-new-title"/>
              </h2>
              <p className='text-light-yellow xs:text-xs md:text-lg xs:max-w-[300px] md:max-w-2xl'>
                <FormattedMessage id="banner-new-text-1"/>
              </p>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className='w-full h-[calc(100vh_-_80px)] flex justify-center items-center bg-slide1 bg-cover bg-center'>
            <div className='w-full h-full bg-black bg-opacity-80 flex items-center justify-center flex-col gap-4'>
              <p className='text-light-yellow xs:text-xs md:text-lg'>
                <FormattedMessage id="banner1-text"/>
              </p>
              <h2 className='text-dark-yellow xs:text-xl md:text-5xl font-bold uppercase'>
          ...
          <div className='w-full h-[calc(100vh_-_80px)] flex justify-center items-center bg-slide2 bg-cover bg-center'>
            <div className='w-full h-full bg-black bg-opacity-80 flex items-center justify-center flex-col'>
              <div className="containeer flex xs:items-center md:items-start justify-center flex-col gap-4">
                <h2 className='text-dark-yellow xs:text-xl md:text-5xl font-bold uppercase'><FormattedMessage id="banner2-title"/></h2>
                <p className='text-light-yellow xs:text-xs md:text-lg'><FormattedMessage id="banner2-text"/></p>
                <p className='text-light-yellow xs:text-xs md:text-lg'><FormattedMessage id="banner2-text2"/></p>
              </div>
            </div>
          </div>
        </SwiperSlide>
          ...
          <div className='w-full h-[calc(100vh_-_80px)] flex justify-center items-center bg-slide3 bg-cover bg-center'>
            <div className='w-full h-full bg-black bg-opacity-80 flex items-center justify-center flex-col gap-4'>
              <div className="containeer flex xs:items-center md:items-end justify-center flex-col gap-4">
                ...
                <p className='text-light-yellow xs:text-center md:text-right xs:max-w-[300px] md:max-w-[600px] xs:text-xs md:text-lg'>
